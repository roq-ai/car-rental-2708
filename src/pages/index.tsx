  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock seamless mobility with Car Rental - Managing profiles, reservations, vehicle usage, and performance assessment in one central hub for carsharing excellence."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1594291465146-1cf039f0ddc2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXJzaGFyaW5nfGVufDB8fHx8MTY5MzU0NjAwN3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock seamless mobility with Car Rental - Managing profiles, reservations, vehicle usage, and performance assessment in one central hub for carsharing excellence.`}
            </Text>
            <Box
