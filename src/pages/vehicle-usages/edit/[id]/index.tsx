      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'hours_used',
              isInvalid: !!formik.errors?.hours_used,
            }}
            name="hours_used"
            error={formik.errors?.hours_used}
            value={formik.values?.hours_used}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('hours_used', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
